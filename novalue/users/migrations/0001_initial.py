    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ava', models.ImageField(blank=True, default='/users/ava/default.png', null=True, upload_to='users/ava/', verbose_name='аватарка')),
                ('background', models.ImageField(blank=True, default='/users/background/default.png', null=True, upload_to='users/background/', verbose_name='фон')),
                ...
                ('smail', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.smail')),
                ('team_sap', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.team_sap')),
            ],
            options={
