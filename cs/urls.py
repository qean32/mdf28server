...
from cs.views import game
from cs.views import team
...
urlpatterns = [
    path('cs/reg/application_meeting/', game.application_meeting_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('cs/reg/meeting/', game.meeting_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('cs/reg/application_tournament/', game.application_tournament_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('cs/reg/offers/', team.offers_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('cs/reg/player/', team.player_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('cs/reg/team/', team.team_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('cs/reg/match/', game.match_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('cs/reg/tournament/', game.tournament_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('cs/reg/record_stat/', game.record_stat_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
]

urlpatterns += path('cs/', include(router.urls)),