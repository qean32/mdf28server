...
from cs.serializers.team import player_search_serializer
from api.serializers_by import user_short_serializer,team_CS_short_serializer
...
class meeting_search_serializer(serializers.ModelSerializer):
    team_one = team_CS_short_serializer()
    team_two = team_CS_short_serializer()
    win_team = team_CS_short_serializer()
    class Meta:
        model = game.meeting_CS
        fields = (
            'id',
