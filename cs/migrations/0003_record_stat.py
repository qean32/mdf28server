    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('match', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='teame1BAqdwfrSCKETBALLe_DOTA_onesdqw', to='cs.match_cs')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='teame1BASCKETqwedswqBALLe_DOTA_onedwsads', to=settings.AUTH_USER_MODEL)),
            ],
            options={
