...
from cs.serializers import team as team_s
...
class player_reg_view(viewsets.ModelViewSet):
    queryset = team.player_CS.objects.all()
...
class player_search_view(permissions.ListViewSet):
    queryset = team.player_CS.objects.order_by('-created_at')
    permission_classes = []
