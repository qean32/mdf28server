...
from b_unification.models.team import team,rank,cup
...
class player_CS(models.Model):
    ...
    generation = models.ForeignKey(generation, models.SET_NULL, null=True, blank=True, related_name='tea123m_ztwo123ew1q2')
...
class player_BASCKETBALL(models.Model):
    ...
    team = models.ForeignKey(team, models.SET_NULL, null=True,blank=True)
    generation = models.ForeignKey(generation, models.SET_NULL, null=True, blank=True, related_name='tea123m_ztw123eo')
    position = models.ManyToManyField('position', blank=True)
    cups = models.ManyToManyField('cup',verbose_name='кубки команды', blank=True)
...
class player_DOTA(models.Model):
    ...
    team = models.ForeignKey(team, models.SET_NULL, null=True,blank=True)
    generation = models.ForeignKey(generation, models.SET_NULL, null=True, blank=True, related_name='tea123m_ztwe12o')
    position = models.ManyToManyField('position', blank=True)
    cups = models.ManyToManyField('cup',verbose_name='кубки команды', blank=True)
