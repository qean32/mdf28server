...
from b_unification.views import game
from b_unification.views import team
from b_unification.views import player
...
urlpatterns = [
    path('unification/reg/application/meeting/', game.application_meeting_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('unification/reg/application/tournament/', game.application_tournament_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('unification/reg/offers/', team.offers_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('unification/reg/player/dota/', player.player_reg_view_DOTA.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('unification/reg/player/cs/', player.player_reg_view_CS.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('unification/reg/player/bascketball/', player.player_reg_view_BASCKETBALL.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('unification/reg/team/', team.team_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('unification/reg/match/', game.match_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('unification/reg/meeting/', game.meeting_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('unification/reg/tournament/', game.tournament_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
]
