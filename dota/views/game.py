...
from dota.serializers import game as game_s
...
class meeting_update_view_for_org(viewsets.ModelViewSet):
    queryset = game.meeting_DOTA.objects.all()
...
class meeting_search_view(permissions.ListViewSet):
    queryset = game.meeting_DOTA.objects.order_by('-created_at')
    permission_classes = []
...
class match_update_view_for_org(viewsets.ModelViewSet):
    queryset = game.match_DOTA.objects.all()
    permission_classes = [permissions.IsNoBan]
...
class match_search_view(permissions.ListViewSet):
    queryset = game.match_DOTA.objects.order_by('-created_at')
    permission_classes = []
    filter_backends = (DjangoFilterBackend,)
...
class application_meeting_update_view(viewsets.ModelViewSet):
    queryset = game.application_DOTA_meeting.objects.all()
    permission_classes = [permissions.IsNoBan]
...
class application_meeting_search_view(permissions.ListViewSet):
    queryset = game.application_DOTA_meeting.objects.order_by('-created_at')
    permission_classes = []
...
class application_tournament_reg_view(viewsets.ModelViewSet):
    queryset = game.application_DOTA_tournament.objects.all()
    permission_classes = [permissions.IsNoBan]
...
class application_tournament_search_view(permissions.ListViewSet):
    queryset = game.application_DOTA_tournament.objects.order_by('-date')
    permission_classes = []
    filter_backends = (DjangoFilterBackend,)
