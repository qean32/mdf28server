...
from dota.views import game
from dota.views import team
...
urlpatterns = [
    ...
    path('dota/reg/application_tournament/', game.application_tournament_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('dota/reg/offers/', team.offers_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('dota/reg/player/', team.player_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('dota/reg/team/', team.team_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('dota/reg/match/', game.match_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
    path('dota/reg/meeting/', game.meeting_reg_view.as_view({
        'post': 'create'
    }), name='cwasdas'),
...
urlpatterns += path('dota/', include(router.urls)),