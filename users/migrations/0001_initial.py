    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ava', models.ImageField(blank=True, default='/users/ava/default.jpg', null=True, upload_to='users/ava/', verbose_name='аватарка')),
                ('background', models.ImageField(blank=True, default='/users/background/default.jpg', null=True, upload_to='users/background/', verbose_name='фон')),
